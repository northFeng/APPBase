...
@implementation APPButtonCellModel
...
+ (APPButtonCellModel *)getCellModelWithLeftImg:(NSString *)leftImg leftText:(NSString *)leftText rightImg:(NSString *)rightImg rightText:(NSString *)rightText index:(NSInteger)index {
    ...
    APPButtonCellModel *model = [[APPButtonCellModel alloc] init];
...
+ (instancetype)buttonWithType:(UIButtonType)buttonType {
    ...
    APPButtonCell *cell = [super buttonWithType:buttonType];
...
- (void)createView {
    ...
    ///右边文字
    _rightLabel = [APPViewTool view_createLabelWithText:@"" font:kFontOfSystem(11*kIpadScale) textColor:DynamicColor(UIColor.grayColor, APPColorFunction.lightTextColor) textAlignment:NSTextAlignmentRight];
